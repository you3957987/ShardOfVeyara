...
- [x] 인벤토리에서 드래그 중에 인벤토리 창 닫히지 않도록 수정
- [x] 인벤토리 열린 상태에서 핫바 아이템 더블 클릭 시 인벤토리로 이동하도록
...
- [x] **상자 시스템 수정**
  - [x] 상자 아이템 더블 클릭 시 인벤토리로 이동하게
  - [x] 상자 열린 상태에서 드래그 중에 창 닫히지 않도록 수정
  - [x] 상자가 열린 상태에서 숫자키 입력 시 핫바 아이템과 스왑
  - [x] 상자가 열린 상태에서 상자 위젯 바깥을 좌클릭 또는 우클릭 후 움직일 시 화면 돌아가는 버그 수정
  - [x] 상자가 열린 상태에서 슬롯 드래그 후 상자 위젯 밖에서 드롭 시 아이템 소환하도록
- [ ] **NPC 시스템 수정**
- [ ] **봉헌 시스템 수정**
