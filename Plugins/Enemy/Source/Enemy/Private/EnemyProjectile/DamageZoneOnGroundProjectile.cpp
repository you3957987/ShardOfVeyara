...
ADamageZoneOnGroundProjectile::ADamageZoneOnGroundProjectile()
{
...
void ADamageZoneOnGroundProjectile::BeginPlay()
{
	Super::BeginPlay();
	...
	GetWorld()->GetTimerManager().SetTimer(DurationTimerHandle, this, 
		&ADamageZoneOnGroundProjectile::DeactivateZone, ZoneDuration, false);
	
	GetWorld()->GetTimerManager().SetTimer(CheckTimerHandle, this, 
		&ADamageZoneOnGroundProjectile::ApplyDamageToOverlappingActors, CheckInterval, true);
}

void ADamageZoneOnGroundProjectile::Tick(float DeltaTime)
{
...
void ADamageZoneOnGroundProjectile::ApplyDamageToOverlappingActors()
{
...
void ADamageZoneOnGroundProjectile::DeactivateZone()
{
