#include "EnemyBoss/Worm/BTTask_WormSelectWeight.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"

UBTTask_WormSelectWeight::UBTTask_WormSelectWeight()
{
	NodeName = "Worm_Select_Weight";
}

EBTNodeResult::Type UBTTask_WormSelectWeight::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	auto ApplyWeights = [&](const TArray<FWormWeightConfig>& Settings)
	{
		for (const FWormWeightConfig& Config : Settings)
		{
